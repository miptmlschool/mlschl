...
\begin{frame}
	...
	\begin{center}
	\( \alpha(a+b) \neq \alpha a+\alpha b\)\\
	не существует отрицательного элемента\\[2em]
    \includegraphics[width=0.7\textwidth]{lists.png}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\pause
	\includegraphics[width=0.7\linewidth]{rgbhsv.jpg}
	\includegraphics[width=0.3\linewidth]{light.png}\\
\end{frame}
